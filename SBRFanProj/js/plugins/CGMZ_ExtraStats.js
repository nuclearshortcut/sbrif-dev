 ...
 * rename the js file.
 * --------------------------Latest Version------------------------------------
 * Hi all, this latest version adds an integration with [CGMZ] Idle to display
 * the total idle frames in the statistics scene. This version also added an
 * integration with [CGMZ] New Game Plus to show the amount of times the
 * player has started a new game plus in the statistics scene.
 *
 * The custom variables will now show the user's locale separator for large
 * numbers, for example instead of 1000 it will show 1,000 or 1.000 depending
 * on where the user is from (or if you have forced a locale through CGMZ
 * Core).
 *
 * Version 1.4.0
...
CGMZ.Versions["Extra Stats"] = "1.4.0";
CGMZ.ExtraStats = {};
